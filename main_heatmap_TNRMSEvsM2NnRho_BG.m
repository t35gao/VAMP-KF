...
size_storage    = [length(rho_BCN_options), length(Ny_options), N_MC, N_time];
    ...
    for i_M2N = 1:length(Ny_options)
        ...
        for i_MC = 1:N_MC
            ...
            for t = 1:N_time
                ...
                NRMSE_x_VAMPKF(i_rho_BCN, i_M2N, i_MC, t) = getNRMSE(xht_VAMPKF, x);
                % -------- update old --------
                ...
                % displaying NRMSE
                fprintf(1, "[rho = %0.1f][M2N = %0.2f][MC = %03d][t = %03d]: ", rho_BCN, M2N, i_MC, t);
                fprintf(1, "e_VAMP-KF = %8.5f\n", NRMSE_x_VAMPKF(i_rho_BCN, i_M2N, i_MC, t));
            end
        end
    end
end
...
imagesc(Ny_options/Nx, rho_BCN_options, TNRMSE_x_VAMPKF);
colormap( flipud(colormap('Gray')) );
colorbar

xlabel('$M/N$', 'interpreter', 'latex')
ylabel('Sparsity ratio $\rho$', 'interpreter', 'latex')


fig_pos     = [10, 80, 900, 440];
