...
size_storage    = [length(alp_options), N_MC, N_time];
...
for i_alp = 1:length(alp_options)
    ...
    for i_MC = 1:N_MC
        ...
        [R0_w, L_R0_w]  = func_randCorrMat(Ny, 'C');
        ...
        for t = 1:N_time
            ...
            % displaying NRMSE
            fprintf(1, '[alp = %0.1f][MC = %03d][t = %03d]: ', alp, i_MC, t);
            fprintf(1, "e_KF = %8.5f"      + ", " + ...
                       "e_EnKF = %8.5f"    + ", " + ...
                       "e_MCC-KF = %8.5f"  + ", " + ...
                       "e_VAMP-KF = %8.5f" + "\n" , ...
                       NRMSE_x_KF(i_alp, i_MC, t), ...
                       NRMSE_x_EnKF(i_alp, i_MC, t), ...
                       NRMSE_x_MCCKF(i_alp, i_MC, t), ...
                       NRMSE_x_VAMPKF(i_alp, i_MC, t));
        end
    end
end
...
semilogy(alp_options, TNRMSE_x_KF, 'DisplayName', 'standard KF', ...
    'LineWidth', 3, 'Color', colors(4,:)); hold on;
errorbar(alp_options, TNRMSE_x_KF, TNRMSE_x_KF_ste/2, 'o', ...
...
semilogy(alp_options, TNRMSE_x_EnKF, 'DisplayName', 'EnKF', ...
    'LineWidth', 3, 'Color', colors(3,:)); hold on;
errorbar(alp_options, TNRMSE_x_EnKF, TNRMSE_x_EnKF_ste/2, 'o', ...
...
semilogy(alp_options, TNRMSE_x_MCCKF, 'DisplayName', 'MCC-KF', ...
    'LineWidth', 3, 'Color', colors(2,:)); hold on;
errorbar(alp_options, TNRMSE_x_MCCKF, TNRMSE_x_MCCKF_ste/2, 'o', ...
...
semilogy(alp_options, TNRMSE_x_VAMPKF, 'DisplayName', 'VAMP-KF', ...
    'LineWidth', 3, 'Color', colors(1,:)); hold on;
errorbar(alp_options, TNRMSE_x_VAMPKF, TNRMSE_x_VAMPKF_ste/2, 'o', ...
    'LineWidth', 2, 'Color', colors(1,:), 'HandleVisibility', 'off'); hold on;

hold off

xlabel('Memory factor $\alpha$', 'interpreter', 'latex')
